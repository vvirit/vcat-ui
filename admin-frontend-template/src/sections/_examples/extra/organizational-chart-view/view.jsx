    ...
    component: (
      <ComponentBox sx={{ overflowY: 'auto', minHeight: 640 }}>
        <OrganizationalChart
          ...
          nodeItem={(props) => <SimpleNode sx={{}} {...props} />} // nodeItem={SimpleNode}
        />
      </ComponentBox>
    ),
  },
    ...
    component: (
      <ComponentBox sx={{ overflowY: 'auto', minHeight: 640 }}>
        <OrganizationalChart
          lineHeight="40px"
          data={SIMPLE_DATA}
          nodeItem={(props) => <StandardNode sx={{}} {...props} />} // nodeItem={StandardNode}
        />
      </ComponentBox>
    ),
  },
    ...
    component: (
      <ComponentBox sx={{ overflowY: 'auto', minHeight: 640 }}>
        <OrganizationalChart
          lineHeight="64px"
          data={GROUP_DATA}
          nodeItem={(props) => <GroupNode sx={{}} {...props} />} // Or nodeItem={GroupNode}
        />
      </ComponentBox>
    ),
  },
